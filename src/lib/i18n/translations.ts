...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      thankYou: 'Thank You!',
      orderSuccess: 'Your order has been processed successfully.',
      orderComplete: 'Order completed!',
      orderFailed: 'Order failed. Please try again.',
      yourKeys: 'Your Game Keys',
      viewAllKeys: 'View All My Keys',
      continueShopping: 'Continue Shopping',
      loginRequired: 'Please login to complete your purchase',
      emptyCart: 'Your cart is empty',
      fillAllFields: 'Please fill all payment fields',
    },
    // Footer
    footer: {
  ...
  ge: {
    ...
    checkout: {
      ...
      expiry: 'ვადა',
      cvv: 'CVV',
      securePayment: 'თქვენი გადახდა უსაფრთხო და დაშიფრულია',
      payNow: 'გადაიხადე ახლა',
      processing: 'მუშავდება...',
      orderSummary: 'შეკვეთის შეჯამება',
      thankYou: 'მადლობა!',
      orderSuccess: 'თქვენი შეკვეთა წარმატებით დამუშავდა.',
      orderComplete: 'შეკვეთა დასრულებულია!',
      orderFailed: 'შეკვეთა ვერ შესრულდა. გთხოვთ სცადეთ ხელახლა.',
      yourKeys: 'თქვენი თამაშის გასაღებები',
      viewAllKeys: 'ყველა ჩემი გასაღების ნახვა',
      continueShopping: 'შოპინგის გაგრძელება',
      loginRequired: 'გთხოვთ შეხვიდეთ შეძენის დასასრულებლად',
  ...
  ru: {
    ...
    checkout: {
      ...
      cvv: 'CVV',
      securePayment: 'Ваш платеж защищен и зашифрован',
      payNow: 'Оплатить',
      processing: 'Обработка...',
      orderSummary: 'Итог заказа',
      thankYou: 'Спасибо!',
      orderSuccess: 'Ваш заказ успешно обработан.',
      orderComplete: 'Заказ выполнен!',
      orderFailed: 'Ошибка заказа. Попробуйте снова.',
      yourKeys: 'Ваши ключи к играм',
      viewAllKeys: 'Посмотреть все мои ключи',
      continueShopping: 'Продолжить покупки',
      loginRequired: 'Войдите, чтобы завершить покупку',
